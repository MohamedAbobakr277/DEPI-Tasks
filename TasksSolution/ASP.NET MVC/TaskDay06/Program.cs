...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!context.Departments.Any())
    {
        ...
        var student1 = context.Students.First(); // Alice Johnson
        var dept1_saved = context.Departments.First();
        
        var course1 = new Course { Name = "C# Programming", Degree = 100, MinDegree = 50, DepartmentId = dept1_saved.Id };
        var course2 = new Course { Name = "Data Structures", Degree = 100, MinDegree = 60, DepartmentId = dept1_saved.Id };
        context.Courses.AddRange(course1, course2);
        context.SaveChanges();

        // One passing, one failing
        context.StuCrsRes.AddRange(
            new StuCrsRes { StudentId = student1.Id, CourseId = course1.Id, Grade = 85 },
            new StuCrsRes { StudentId = student1.Id, CourseId = course2.Id, Grade = 40 }
        );
        context.SaveChanges();
    }
}
